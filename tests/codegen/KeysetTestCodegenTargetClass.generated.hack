...
final class KeysetTestCodegenTargetClass {
  public static function keysetOfString(mixed $htl_untyped_variable): keyset<string> { $out__1 = keyset[]; foreach (($htl_untyped_variable as keyset<_>) as $k__1) { $out__1[] = $k__1 as string; } return $out__1; }
