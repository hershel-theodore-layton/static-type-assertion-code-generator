...
final class VecTestCodegenTargetClass {
  public static function vecOfNum(mixed $htl_untyped_variable): vec<num> { $out__1 = vec[]; foreach (($htl_untyped_variable as vec<_>) as $v__1) { $out__1[] = $v__1 as num; } return $out__1; }
