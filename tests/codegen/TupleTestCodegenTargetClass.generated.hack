...
final class TupleTestCodegenTargetClass {
  ...
  public static function tupleIntMixedVecOfIntBool(mixed $htl_untyped_variable): (int, vec<int>, bool) { $partial__1 = $htl_untyped_variable as (int, mixed, bool); return tuple($partial__1[0], () ==> { $out__2 = vec[]; foreach (($partial__1[1] as vec<_>) as $v__2) { $out__2[] = $v__2 as int; } return $out__2; }(), $partial__1[2]); }
